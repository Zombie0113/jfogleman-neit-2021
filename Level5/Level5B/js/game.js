...
var player;
	...
	platform1 = new GameObject();
		platform1.height = canvas.height;
		platform1.x = canvas.width;
...
function animate()
{
	...
	while(platform1.hitTestPoint(player.left()) && player.vx <=0 && d)
	{
		player.x++;
		player.y--;
		player.vx = 0;
	...
	while(platform1.hitTestPoint(player.right()) && player.vx >=0 && d)
	{
		player.x--;
		player.y--;
		player.vx = 0;
	...
	while(platform1.hitTestPoint(player.top()) && player.vy <=0 && !space)
	{
		player.y++;
		player.vy = 0;
	}
