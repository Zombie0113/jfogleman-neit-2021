...
function animate()
{
    ...
    ctx.fillText("Scores", canvas.width/2-37, 25);
    ctx.fillText("P1: " + p1Total + " | P2: " + p2Total, canvas.width/2-78, 50);
    ...
    //Add image to ball
    ctx.drawImage(img, ball.x-40, ball.y-40, ball.width*1.5, ball.height*1.5);
}